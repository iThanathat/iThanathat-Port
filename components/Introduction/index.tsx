...
const Introduction = () => {
  return (
    <div className="h-screen flex items-center justify-center">
      ...
      <div className="container p-6 w-1/2 h-full bg-primary flex flex-col justify-center" style={{wordBreak: 'break-word'}}>
        <div className="m-auto">
          ...
          <div className="mt-4">
            <div className="text-primary-content flex items-center">
              ...
              <p className="ml-6 text-xl">Software engineer based in Bangkok, Thailand.</p>
            </div>
            <br/>
            <div className="text-primary-content flex items-center">
              <p className="text-2xl">📸</p>
            ...
            <div className="text-primary-content flex items-center">
              <p className="text-2xl">💼</p>
              <p className="ml-6 text-xl">Working at Billme Venture Co., Ltd.</p>
            </div>
          </div>
